...
// Run this from the backend directory: node export-database-data.js
...
async function exportDatabase() {
    ...
    try {
        ...
        console.log('  2. On server, run: cd /var/www/Upload/database-export && bash import-to-server.sh\n');
