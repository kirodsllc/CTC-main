        ...
        if (res.statusCode === 200) {
          try {
            ...
            if (json.data && json.data.length > 0) {
              ...
              console.log(`Classifications: Fast=${json.data.filter(i => i.classification === 'Fast').length}, Normal=${json.data.filter(i => i.classification === 'Normal').length}, Slow=${json.data.filter(i => i.classification === 'Slow').length}, Dead=${json.data.filter(i => i.classification === 'Dead').length}`);
            }
